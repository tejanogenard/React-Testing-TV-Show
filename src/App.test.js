...
const episodeData = {
 ...
 it('should render the season data when the Select Season button is clicked',
 async() => {
     mockFetchShows.mockResolvedValueOnce(episodeData)
     ...
     useEvent.click(getByText(/select a season/i))

   
   expect(getByText(/season 1/i)).toBeDefined()
