...
it('should render the list of episodes after API call', () => {
    //render component with an empty array for the episodes
    // re-render the component with episode data 

    const { rerender, debug, getByText, queryAllByTestId } = render(<Episodes episodes = {[]} />)

    rerender(<Episodes episodes={[episodeData]} />)

    //query for the episodes being rerendered 
